...
## ⚠️ Read this first — hardware mismatch

Your written spec said **ESP32-S3 + ST7796 320×480**, but the datasheet you
uploaded is the **LCDWIKI E32R28T**, which is:

| | Your spec | Your actual board (datasheet) |
|---|---|---|
| MCU | ESP32-S3 | **ESP32-WROOM-32E** |
| Driver | ST7796 | **ILI9341** |
| Resolution | 320×480 | **240×320** (320×240 landscape) |

This project is built for **the board you actually have** (ILI9341 240×320).
If you really are on the S3/ST7796 board, see *Switching boards* below — it's a
...
## Switching to the ESP32-S3 / ST7796 board
...
just another preset. I couldn't flash this to hardware here, so treat the first
upload as a bring-up: expect to tune colours, eye size/gap, and SPI speed in
`Config.h`. Start by confirming the panel lights up, then adjust from there.
